...
export const LEVELS: LevelConfig[] = [
  {
    id: 1,
    name: '第一关：新手训练',
    description: '熟悉矿车操作，完成一次简单的采矿和返回。注意观察太阳能区的阴影节奏！',
    difficulty: 1,
    ...
    trackNodes: [
      ...
      { id: 'n6', x: 1050, y: 200, connections: ['n4', 'n7'], trackType: 'weak' },
      { id: 'n7', x: 1050, y: 500, connections: ['n5', 'n6', 'n8'] },
      { id: 'n8', x: 1200, y: 500, connections: ['n7'] }
    ],
    baseStations: [
      { id: 'b-start', nodeId: 'n0', type: 'start', name: '出发点' },
      { id: 'b-mine1', nodeId: 'n4', type: 'mine', name: '轻矿点Alpha', oreValue: 450, oreWeight: 5, oreType: 'light' },
      { id: 'b-mine2', nodeId: 'n6', type: 'mine', name: '重矿点Beta', oreValue: 1300, oreWeight: 23, oreType: 'heavy' },
    ...
    shadowZones: [
      { id: 'sz1', stationId: 'b-solar1', type: 'tower', cycleDuration: 20, shadowDuration: 8, offset: 5 }
    ],
    weightBrakeFactor: 3,
    weakTrackCollapseWeight: 20
  },
  {
    id: 2,
    name: '第二关：熔炼增值',
    description: '学会使用熔炼站提升矿石价值。轻重矿石取舍：轻矿加速快但分低，重矿价值高却拉长刹车距离！',
    difficulty: 2,
    ...
    trackNodes: [
      ...
      { id: 'n6', x: 550, y: 600, connections: ['n4', 'n8'], trackType: 'weak' },
      ...
      { id: 'n9', x: 1000, y: 150, connections: ['n7', 'n11'], trackType: 'weak' },
    ...
    baseStations: [
      { id: 'b-start', nodeId: 'n0', type: 'start', name: '出发点' },
      { id: 'b-mine1', nodeId: 'n5', type: 'mine', name: '轻矿点Alpha', oreValue: 400, oreWeight: 6, oreType: 'light' },
      { id: 'b-mine2', nodeId: 'n6', type: 'mine', name: '重矿点Beta', oreValue: 1200, oreWeight: 22, oreType: 'heavy' },
      { id: 'b-smelter', nodeId: 'n9', type: 'smelter', name: '熔炼站', valueMultiplier: 1.8 },
      { id: 'b-solar1', nodeId: 'n3', type: 'solar', name: '太阳能区A', powerRestore: 35 },
      { id: 'b-solar2', nodeId: 'n10', type: 'solar', name: '太阳能区B', powerRestore: 30 },
    ...
    shadowZones: [
      { id: 'sz1', stationId: 'b-solar1', type: 'tower', cycleDuration: 16, shadowDuration: 7, offset: 3 },
      { id: 'sz2', stationId: 'b-solar2', type: 'meteor_cloud', cycleDuration: 22, shadowDuration: 9, offset: 8 }
    ],
    weightBrakeFactor: 4,
    weakTrackCollapseWeight: 18
  },
  {
    id: 3,
    name: '第三关：终极挑战',
    description: '多采矿点、弱轨道、阴影节奏、陨石密集！取舍轻重矿石、观察光照、分批运输，考验你的全局规划！',
    difficulty: 3,
    ...
    trackNodes: [
      ...
      { id: 'n3', x: 280, y: 550, connections: ['n1', 'n5'], trackType: 'weak' },
      ...
      { id: 'n8', x: 460, y: 720, connections: ['n5', 'n11'], trackType: 'weak' },
      ...
      { id: 'n12', x: 1000, y: 180, connections: ['n9', 'n15'], trackType: 'weak' },
      ...
      { id: 'n16', x: 1000, y: 550, connections: ['n13', 'n15', 'n18'], trackType: 'weak' },
    ...
    baseStations: [
      { id: 'b-start', nodeId: 'n0', type: 'start', name: '出发点' },
      { id: 'b-mine1', nodeId: 'n6', type: 'mine', name: '轻矿点Alpha', oreValue: 350, oreWeight: 5, oreType: 'light' },
      { id: 'b-mine2', nodeId: 'n8', type: 'mine', name: '重矿点Beta', oreValue: 1100, oreWeight: 22, oreType: 'heavy' },
      { id: 'b-mine3', nodeId: 'n12', type: 'mine', name: '重矿点Gamma', oreValue: 1400, oreWeight: 28, oreType: 'heavy' },
    ...
    shadowZones: [
      { id: 'sz1', stationId: 'b-solar1', type: 'tower', cycleDuration: 14, shadowDuration: 6, offset: 2 },
      { id: 'sz2', stationId: 'b-solar2', type: 'meteor_cloud', cycleDuration: 18, shadowDuration: 8, offset: 5 }
    ],
    weightBrakeFactor: 5,
    weakTrackCollapseWeight: 16
  }
];
